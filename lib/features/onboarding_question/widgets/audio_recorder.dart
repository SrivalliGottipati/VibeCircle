...
//   List<double> amps = List.filled(40, 8);
...
//
//     _sub = _rec.onAmplitudeChanged(const Duration(milliseconds: 80)).listen((a) {
//       setState(() {
//         amps = List.generate(40, (_) => 6 + Random().nextDouble() * 22);
//       });
//     });
//
...
//                   painter: _RecordWavePainter(amps),
//                 ),
//               ),
...
// }
//
// class _RecordWavePainter extends CustomPainter {
//   final List<double> bars;
//   _RecordWavePainter(this.bars);
//
//   @override
...
//     final spacing = 4.0;
//     final totalBarWidth = 3.0;
//     final step = totalBarWidth + spacing;
//
